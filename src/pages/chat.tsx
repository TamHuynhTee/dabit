...
function Chat({}: Props) {
  const chatApi = {
    addChat(payload: any): Promise<ReturnResponse<any>> {
      const url = '/api/chat/add'; //params : page, filter
      return API.post({ url, headers: { ...getAuthHeader() }, body: payload });
    },

    getListChat(): Promise<ReturnResponse<any>> {
      const url = '/api/chat/list'; //params : page, filter
      return API.get({ url, headers: { ...getAuthHeader() } });
    },

    getChat(payload: any): Promise<ReturnResponse<any>> {
      const url = '/api/chat/get'; //params : page, filter
      return API.post({ url, headers: { ...getAuthHeader() }, body: payload });
    },
  ...
  const authApi = {
    getInfo(): Promise<ReturnResponse<any>> {
      const url = '/api/auth/profile'; //params : page, filter
      return API.get({ url, headers: { ...getAuthHeader() } });
    },
  };
  ...
  //   console.log(`file: chat.tsx:39 => chat`, chat)
